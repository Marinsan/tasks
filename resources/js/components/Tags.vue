<template>
    ...
    <div class="flex flex-col">
        ...
        <div>
            <form>
            <input type="text"
                   v-model="newTag" @keyup.enter="add"  placeholder="Nou Tag" required class="m-3 p-2 shadow border rounded focus:outline-none focus:shadow-outline text-grey-dark">
