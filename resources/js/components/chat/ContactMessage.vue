    ...
    return {
      ...
      channels: [
        ...
        },
        {
          id: 2,
          title: "Classes",
          members: "John, Acacha, James, Bart",
          avatar: "http://i.pravatar.cc/300?saregedsrea"
        },
        {
          id: 3,
          title: "Scool",
          members: "Pepe, Acacha, James",
          avatar: "http://i.pravatar.cc/300?swegvrfg"
        }
      ],
      searching: false
    };
    ...
    getFilteredChannels() {
      return this.channels.filter(item => {
        if (
          ...
          item.members.toUpperCase().includes(this.search.toUpperCase())
        )
          return true;
        else return false;
      });
