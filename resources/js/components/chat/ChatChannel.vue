  ...
  <div>
    <v-toolbar color="primary" flat>
      ...
      <v-tooltip bottom>
        <v-btn
          slot="activator"
          icon
          @click.stop.prevent="drawerSearchMessage = !drawerSearchMessage"
        >
    ...
    <v-container fluid text-xs-center class="ma-0 pa-0">
      <v-layout row wrap class="mx-0">
        <v-flex
          xs12
          style="overflow-y:auto;max-height: calc(100vh - 64px - 64px - 64px);"
          class="p-4 bg-pattern"
        >
          <v-list subheader style="background-color: transparent;">
            <contact-message :owner="false"></contact-message>
            <image-message
              :owner="true"
              src="https://pbs.twimg.com/profile_images/1008272534243078144/PySRvtbQ_400x400.jpg"
            ></image-message>
