...
return [
    ...
    */
    ...
    'admin_user_name_on_tasks' => env('ADMIN_USER_NAME_ON_TENANT','Cristian Marin Tejeda'),
    'admin_user_email_on_tasks' => env('ADMIN_USER_EMAIL_ON_TENANT','cristianmarin@iesebre.com'),
    'admin_username_password_on_tasks' => env('ADMIN_USER_PASSWORD_ON_TENANT','7c4a8d09ca3762af61e59520943dc26494f8941b'),
